  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center text-center p-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full max-w-lg">
        <button className="flex-1 bg-[#d4ff00] text-black px-6 py-4 rounded-xl font-bold hover:bg-[#bce600] transition-colors flex items-center justify-center gap-3 text-sm shadow-[0_0_20px_rgba(212,255,0,0.15)]">
          <LinkIcon className="w-4 h-4" /> Connect Integrations
        </button>
        <button className="flex-1 bg-[#1a1c23] border border-white/10 text-white px-6 py-4 rounded-xl font-bold hover:bg-white/5 transition-colors flex items-center justify-center gap-3 text-sm">
